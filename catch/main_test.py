...
from tsppo import Actor, Critic, Recurrent
...
def Train():
    ...
    # net = Recurrent(
    #     layer_num=1,
    #     state_shape=algo_config.state_shape[0] - algo_config.god_view_shape[0],
    ...
    # net_c = Recurrent(
    #     layer_num=1,
    #     state_shape=algo_config.state_shape[0],
    #     action_shape=algo_config.action_shape,
    #     device=algo_config.device,
    #     hidden_layer_size=32,
    # )
    ...
    if algo_config.use_god_view == False:
        net_c = net
    ...
    if not algo_config.watch_agent:
        if algo_config.using_tensorboard:
            ...
            name=algo_config.wb_name,  # 实验名称
            project=algo_config.wb_project,  # 项目名称
